...
var SolarCycleTaijitu = /** @class */ (function () {
    function SolarCycleTaijitu() {
        ...
        this.drawOrbit = function (planet, center) {
            ...
            _this.cx.lineWidth = Number("" + planet.mass / 2);
            _this.cx.stroke();
        };
        /**
        ...
        this.setWhite = function (alpha) {
            ...
            _this.cx.fillStyle = "rgba(225, 225, 225, " + alpha + ")";
            _this.cx.strokeStyle = "rgba(255, 255, 255, " + alpha + ")";
        };
        /**
        ...
        this.setBlack = function (alpha) {
            if (alpha === void 0) { alpha = 1; }
            //temporary
            _this.cx.fillStyle = "rgba(125, 25, 25, " + alpha + ")";
            _this.cx.strokeStyle = "rgba(0, 210, 0, " + alpha + ")";
        };
        /**
